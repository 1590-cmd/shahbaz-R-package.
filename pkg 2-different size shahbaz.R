...
# sizes(P1 and P2) Rull-II These designs Generated with R-package.
...
design<-function(H){
  ...
  setMethod("show", "CWBND_design", function(object) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row, "\n")
    cat("This design is generated through above computed sets of shifts  for", "v=" ,object$R[1],"p1=",object$R[2], "and","p2=",object$R[3], "\n")
    row <- paste(rep("=", 51), collapse = "")
    cat(row, "\n")
...
Create_Designs<-function(v,p1,p2,D,C,i){
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  cat("MCBRMDs is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"and","n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")    
  cat("MCBRMDs is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v-1-p2)%%(p1)==0 & (i=(v-1-p2)/(p1)) & (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")        
  cat("MCPBRMDs-I is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")    
  cat("MCPBRMDs-I is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v-2-p2)%%(p1)==0 & (i=(v-2-p2)/(p1)) & (i%%1==0) &(i>0)){
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")      
  cat("MCPBRMDs-II is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v-2-(2*p2))%%(p1)==0 & (i=(v-2-(2*p2))/(p1)) & (i%%1==0) &(i>0)){
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")        
  cat("MCPBRMDs-II is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v+1-p2)%%(p1)==0 & (i=(v+1-p2)/(p1))& (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")        
  cat("MCWBRMDs-I is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v+1-(2*p2))%%(p1)==0 & (i=(v+1-(2*p2))/(p1))& (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")          
  cat("MCWBRMDs-I is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v+2-p2)%%(p1)==0 & (i=(v+2-p2)/(p1)) & (i%%1==0) &(i>0)){
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")              
  cat("MCWBRMDs-II is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")              
  cat("MCWBRMDs-II is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")
  ...
  if((v+1-p2)%%(p1)==0 & (i=(v+1-p2)/(p1))& (i%%1==0) &(i>0) ) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")                  
  cat("MCNSBRMDs is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v+1-(2*p2))%%(p1)==0 & (i=(v+1-(2*p2))/(p1)) & (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")                    
  cat("MCNSBRMDs is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")                      
  cat("MCSPBRMDs-I is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v-(2*p2))%%(p1)==0 & (i=(v-2*p2)/(p1))& (i%%1==0) &(i>0) ){
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")                    
  cat("MCSPBRMDs-I is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v-1-p2)%%(p1)==0 & (i=(v-1-p2)/(p1))& (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")                          
  cat("MCSPBRMDs-II is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")                            
  cat("MCSPBRMDs-II is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")                          
  cat("MCSBGRMDs-I is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")
  ...
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")                             
  cat("MCSBGRMDs-I is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")
  ...
  if((v+3-p2)%%(p1)==0 & (i=(v+3-p2)/(p1)) & (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")                                  
  cat("MCSBGRMDs-II is possible with one sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+1)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")  
  ...
  if((v+3-2*p2)%%(p1)==0 & (i=(v+3-2*p2)/(p1)) & (i%%1==0) &(i>0)) {
    row <- paste(rep("=", 51), collapse = "")
    cat(row,"\n")                                    
  cat("MCSBGRMDs-II is possible with two sets of p2 ","v=",v,"P1=",p1,"P2=",p2,"i=",i,"n=",(i+2)*(v-1),"\n")
  row <- paste(rep("=", 51), collapse = "")
  cat(row,"\n")
  (H<-RMD_2diffsize(p=c(p1,p2),v=v,i=i,C=10,D=2)) 
}else
                                
  cat("MCBRMDs,MCPBRMDs-I,MCPBRMDs-II,MCWBRMDs-I,MCWBRMDs-II,MCNSBRMDs,MCSPBRMDs-I,MCSPBRMDs-II,MCSBGRMDs-I and MCSBGRMDs-II are not possible ","v=",v,"P1=",p1,"P2=",p2,"i=",i,rep("", 40))
...
(H<-Create_Designs(v=24, p1=8, p2=6))
(D<-design(H))
