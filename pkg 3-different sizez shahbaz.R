...
################################################################################
# Minimal Classes of Circular balance RMDs for period of three different
# sizes(P1, P2 and P3)
################################################################################
...
# sizes(P1, P2 and P3)  These designs Generated with R package. 


# Coded by shahbaz et al., 01-01-2025 to 20-02-2025
...
design<-function(H){
  ...
  setMethod("show", "CWBND_design", function(object) {
    ...
    cat(row, "\n")
    cat("This design is generated through above computed sets of shifts for", "v=" ,object$R[1],"k1=",object$R[2],"k2=",object$R[3], "and","k3=",object$R[4], "\n")
    row <- paste(rep("=", 51), collapse = "")
    cat(row, "\n")
  ...
  for(j in 1:length(ss)){ 
    ...
    for(i in 1:nr){
      ...
      rr<-dd[which(dd>=v)]%%v
      dd[which(dd>=v)]<-rr
      if(j==ccc){dd<-rbind(dd, rep((v), ncol(dd))) }
      colnames(dd)<-paste("S",fn, sep="")
      rownames(dd)<-NULL
      fn<-fn+v
      D[[i]]<-dd
    }
...
Create_Designs<-function(v,p1,p2,p3,D,C,i){
  ...
  cat("MCBRMDs is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=1,D=1))  
}else
  #if((v-2*p2-p3)%%(p1)==0 & (i=(v-2*p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  #cat("MCBRMDs is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  #(H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=1,D=2))  
#}else 
  if((v-p2-2*p3)%%(p1)==0 & (i=(v-p2-2*p3)/(p1)) ){
  cat("MCBRMDs is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=1,D=3)& (i%%1==0) &(i>0))  
}else
  if((v-2*p2-2*p3)%%(p1)==0 & (i=(v-2*p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCBRMDs is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=1,D=4))  
}else        
  if((v-1-p2-p3)%%(p1)==0 & (i=(v-1-p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCPBRMDs-I is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=2,D=1))  
}else
  if((v-1-2*p2-p3)%%(p1)==0 & (i=(v-1-2*p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCPBRMDs-I is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=2,D=2))  
}else 
  if((v-1-p2-2*p3)%%(p1)==0 & (i=(v-1-p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCPBRMDs-I is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=2,D=3))  
}else
  if((v-1-2*p2-p3)%%(p1)==0 & (i=(v-1-2*p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCPBRMDs-I is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=2,D=4))  
}else
  if((v-2-p2-p3)%%(p1)==0 & (i=(v-2-p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCPBRMDs-II is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=3,D=1))  
}else
  if((v-2-2*p2-p3)%%(p1)==0 & (i=(v-2-2*p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCPBRMDs-II is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=3,D=2))  
  }else 
  #if((v-2-p2-2*p3)%%(p1)==0 & (i=(v-2-p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  #cat("MCPBRMDs-II is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  #(H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=3,D=3))  
#}else
  if((v-2-2*p2-2*p3)%%(p1)==0 & (i=(v-2-2*p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCPBRMDs-II is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=3,D=4))  
}else
  #if((v+1-p2-p3)%%(p1)==0 & (i=(v+1-p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  #cat("MCWBRMDs-I is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  #(H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=4,D=1))  
#}else
  if((v+1-2*p2-p3)%%(p1)==0 & (i=(v+1-2*p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCWBRMDs-I is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=4,D=2))  
}else 
  if((v+1-p2-2*p3)%%(p1)==0 & (i=(v+1-p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCWBRMDs-I is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=4,D=3))  
}else
  if((v+1-2*p2-2*p3)%%(p1)==0 & (i=(v+1-2*p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCWBRMDs-I is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=4,D=4))  
}else
  if((v+2-p2-p3)%%(p1)==0 & (i=(v+2+p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCWBRMDs-II is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=5,D=1))  
}else
  if((v+2-2*p2-p3)%%(p1)==0 & (i=(v+2-2*p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCWBRMDs-II is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=5,D=2))  
}else 
  if((v+2-p2-2*p3)%%(p1)==0 & (i=(v+2-p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCWBRMDs-II is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=5,D=3))  
}else
  if((v+2-2*p2-2*p3)%%(p1)==0 & (i=(v+2-2*p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCWBRMDs-II is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=5,D=4))  
}else
  #if((v+1-p2-p3)%%(p1)==0 & (i=(v+1-p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  #cat("MCNSBRMDs is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  #(H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=6,D=1))  
#}else
  if((v+1-2*p2-p3)%%(p1)==0 & (i=(v+1-2*p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCNSBRMDs is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=6,D=2))  
}else 
  if((v+1-p2-2*p3)%%(p1)==0 & (i=(v+1-p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCNSBRMDs is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=6,D=3))  
}else
  if((v+1-2*p2-2*p3)%%(p1)==0 & (i=(v+1-2*p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCNSBRMDs is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=6,D=4))  
}else
  if((v-p2-p3)%%(p1)==0 & (i=(v+p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSPBRMDs-I is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=7,D=1))  
}else
  #if((v-2*p2-p3)%%(p1)==0 & (i=(v-2*p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  #cat("MCSPBRMDs-I is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  #(H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=7,D=2))  
#}else 
  if((v-p2-2*p3)%%(p1)==0 & (i=(v-p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSPBRMDs-I is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=7,D=3))  
}else
  if((v-2*p2-2*p3)%%(p1)==0 & (i=(v-2*p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCSPBRMDs-I is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=7,D=4))  
}else
  if((v-1-p2-p3)%%(p1)==0 & (i=(v-1+p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCSPBRMDs-II is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=8,D=1))  
}else
  if((v-1-2*p2-p3)%%(p1)==0 & (i=(v-1-2*p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCSPBRMDs-II is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=8,D=2))  
}else 
  if((v-1-p2-2*p3)%%(p1)==0 & (i=(v-1-p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSPBRMDs-II is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=8,D=3))  
}else
  if((v-1-2*p2-2*p3)%%(p1)==0 & (i=(v-1-2*p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSPBRMDs-II is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=8,D=4))  
}else
  if((v+2-p2-p3)%%(p1)==0 & (i=(v+2+p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSBGRMDs-I is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=9,D=1))  
}else
  if((v+2-2*p2-p3)%%(p1)==0 & (i=(v+2-2*p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSBGRMDs-I is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=9,D=2))  
}else 
 if((v+2-p2-2*p3)%%(p1)==0 & (i=(v+2-p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
 cat("MCSBGRMDs-I is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
 (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=9,D=3))  
}else
 if((v+2-2*p2-2*p3)%%(p1)==0 & (i=(v+2-2*p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
 cat("MCSBGRMDs-I is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
 (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=9,D=4))  
}else
                                                                          
  if((v+3-p2-p3)%%(p1)==0 & (i=(v+3+p2-p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSBGRMDs-II is possible with one set of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=10,D=1))  
}else
  if((v+3-2*p2-p3)%%(p1)==0 & (i=(v+3-2*p2-p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCSBGRMDs-II is possible with two sets of p2 and one set of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+1)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=10,D=2))  
}else 
  if((v+3-p2-2*p3)%%(p1)==0 & (i=(v+3-p2-2*p3)/(p1))& (i%%1==0) &(i>0) ){
  cat("MCSBGRMDs-II is possible with one set of p2 and two sets of p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+1+2)*(v-1))
  (H<-CGN2_3diffsize(p=c(p1,p2,p3),v=v,i=i,C=10,D=3))  
}else
  if((v+3-2*p2-2*p3)%%(p1)==0 & (i=(v+3-2*p2-2*p3)/(p1)) & (i%%1==0) &(i>0)){
  cat("MCSBGRMDs-II is possible with two sets of p2 and p3 ","v=",v,"P1=",p1,"P2=",p2,"p3=",p3,"i=",i,"and","n=",(i+2+2)*(v-1))
...
(H<-Create_Designs(v=19, p1=6, p2=5, p3=3))
(D<-design(H))
